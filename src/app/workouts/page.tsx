...
const TheLibrary = async () => {
    ...
    return (
        <div>
                ...
                <div className="container mx-auto px-28">
                    ...
                    <div className="grid grid-cols-1 items-center overflow-hidden rounded-3xl border border-gray-600 bg-base-300 shadow-xs md:grid-cols-2">
                        ...
                        <div className="ps-7 py-10 text-center md:py-14 md:text-left">
                            ...
                            <a
                                href="#library"
                                className="cursor-pointer mt-8 inline-flex items-center gap-2 rounded-xl bg-[#C2F800] px-7 py-3.5 text-lg font-semibold text-black shadow-lg shadow-green-600/20 transition-all duration-300 hover:-translate-y-1 hover:bg-green-700 hover:shadow-xl"
                            >
                                BROWSE WORKOUTS
                            </a>
                        </div>
            ...
            <section id="library" className="container mx-auto my-16 px-28">
